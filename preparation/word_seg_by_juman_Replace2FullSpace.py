...
# df_train_out.to_csv('/mnt/gold/users/s18153/prjPyCharm/prjNLP_GPU/data/train_w_FullSpace.csv', header=False, index=False)
...
df_test_out.to_csv('/mnt/gold/users/s18153/prjPyCharm/prjNLP_GPU/data/test_w_FullSpace.csv', header=False, index=False)
